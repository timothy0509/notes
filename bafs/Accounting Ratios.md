...
$$\text{net profit ratio (\%)}=\frac{\text{net profit before tax}}{\text{sales}}$$
$$\text{return on captial employed (\%)}=\frac{\text{profit before interest and tax}}{\text{average capital employed}}$$
> [!info] Capital employed
> For sole proprietorships, capital employed refers to the capital balance.
...
$$
$$
\text{average trade receivables collection period (days/months)}=\frac{\text{average trade receivables}}{\text{credit sales}}\times{\text{365 days or 12 months}}
$$
$$
\text{trade receivables turnover (times)}=\frac{\text{credit sales}}{\text{average trade receivables}}
$$
$$
\text{average trade payables repayment period (days/months)}=\frac{\text{average trade payables}}{\text{credit purchases}}\times{\text{365 days or 12 months}}
$$
$$
...
$$
$$
\text{dividend cover for ordinary shares (times)}=\frac{\text{net profit after tax}-\text{preference dividend}}{\text{ordinary dividend paid}}
$$
$$
