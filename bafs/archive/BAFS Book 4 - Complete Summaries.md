  ...
  root((Financial Analysis))
    Accounting Ratios
      ...
      Liquidity Ratios
        ...
        Average trade payables repayment period
        Inventory turnover
      Solvency Ratio
        Gearing ratio
    ...
    Limitations
      Cannot tell whole story
      Not fair to compare different businesses
      Based on past results
      No universal norms
      Cannot identify specific problems
```
...
```mermaid
mindmap
  root((Incomplete Records))
    Deduction of Sales
      Cash sales from cash book
      Credit sales from trade receivables
      ...
      Adjustments
        ...
        Set-offs
        Sales allowance
    Deduction of Financial Position
...
```mermaid
mindmap
  root((Absorption vs Marginal Costing))
    Absorption Costing
      Product Costs
        Direct materials
        Direct labour
    ...
    Comparison
      ...
      Profit differs when inventory changes
...
```mermaid
mindmap
  root((Cost Accounting for Decision Making))
    Relevant vs Irrelevant
      Relevant Costs
        Future costs to be considered
        Opportunity costs
        Incremental costs
        Avoidable costs
      Irrelevant Costs
