---
title: Database Class Practice - SQL
subject: ICT
tags: [ict, database, sql, practice]
status: in-progress
---
# Practice
...
| Select rows                             | **List** all rows of 'Pikachu'                                                                                   | `SELECT * FROM pet`<br>`SET NAME = 'Raichu' WHERE id = 4;`                                  |
...
| **Question 1**                          | Can you add another pets with id=2?                                                                              | Yes, but with a different name                                                              |
| **Question 2**                          | What is the purpose of primary key?                                                                              | Uniquely identify a record                                                                  |
| **Question 3**                          | Is the primary key meaningful?                                                                                   | No, just an arbitrary integer                                                               |
| **Question 4**                          | How to set arbitrary primary key easily?                                                                         | Use `==AUTO_INCREMENT==`                                                                        |
| **Question 5**                          | Can the primary key be meaning? Give an example.                                                                 | Yes, we can construct the id using other field. For example, F03 represents fire monster #3 |
