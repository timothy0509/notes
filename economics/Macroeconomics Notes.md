...
3. Must have a market value
4. Must be current production
### Measurement of GDP
#### Expenditure Approach
The expenditure approach measures the total expenditure on final goods and service produced by resident producing unites in a given period of time.

The expenditures can be classified into:
- **Private consumption expenditure** (C)
- **Gross investment expenditure** (I)
- **Government consumption expenditure** (G)
- **Exports** (X)

The expenditures include spending on foreign goods and services. Therefore, **imports** (M) have to be subtracted from these expenditures to obtain GDP.

The formula of GDP using expenditure approach is:
$$
\text{GDP} = C+I+G+X-M
$$
#### Production Approach/Value-added Approach
The production approach measures the sum of the value added of all resident producing units.
#### Income Approach
The income approach adds up all income earned by the factors of production employed by HK's resident producing units
